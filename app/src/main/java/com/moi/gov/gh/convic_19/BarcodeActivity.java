...
public class BarcodeActivity extends AppCompatActivity {
    ...
    public static final String yourcode = "BarcodeKey";
    ...
    private void initViews() {
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (barcode.length() > 0) {
                    startActivity(new Intent(BarcodeActivity.this, PateintDetailsActivity.class).putExtra("MININFO", barcode));
                }
                ...
                if (barcodes.size() != 0) {
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            txtBarcodeValue.setText(eip[1].trim());
                            barcode = eip[1].trim();
                        }
                    });
